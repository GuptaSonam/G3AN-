...
parser.add_argument('--src_dir', type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/data/weizmann_action/merged_flip', help='')
parser.add_argument('--dst_dir', type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/data/weizmann_action/merged_frames_flip', help='')
