...
from trainer_G4 import train
from model.networks_G4 import Generator_G4, VideoDiscriminator, ImageDiscriminator
import torchvision
import transforms_vid
from dataset_weizmann import WZM
...
def main():
	...
	for epoch in range(args.max_epoch):
		...
		if epoch % args.val_freq == 0:
			vis(epoch, G, fixed_zfg, fixed_zbg, fixed_zm, device)
		'''
