...
def parse_args():
	...
	# train
	parser.add_argument('--max_epoch', type=int, default=8001, help='number of epochs of training')
	...
	parser.add_argument('--exp_name', type=str, default='g4an_wzm_flip_sample_1_2_with_masking_v3_no_Gf')
	parser.add_argument('--save_path', type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/g4an-3gpu/exps', help='model and log save path')
	parser.add_argument('--data_path', type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/data/weizmann_action/merged_frames_flip', help='dataset path')
	parser.add_argument('--use_attention', action='store_true', default=False, help='whether to use attention')
	parser.add_argument('--random_seed', type=int, default='12345')

	# test
	parser.add_argument('--n', type=int, default=2, help='number of random generation')
	parser.add_argument('--n_za_test', type=int, default=1, help='number of appearance')
	parser.add_argument('--n_zm_test', type=int, default=1, help='number of motion')
	parser.add_argument('--demo_name', type=str, default='v1', help='name of demo')
	parser.add_argument('--model_path', type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/g4an-3gpu/exps/g4an_wzm_flip_sample_1_2_with_masking_v3_after_5000/models/G_3000.pth', help='pre-trained model path')
