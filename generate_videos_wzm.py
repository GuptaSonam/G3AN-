...
if __name__ == '__main__':
	...
	parser.add_argument("--model_path", type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/g4an-3gpu/exps/g4an_wzm_flip_sample_1_2_with_masking_v3_Gv_only/models/G_5000.pth')
	parser.add_argument("--gen_path", type=str, default='/media/vplab/Sonam_HDD/sonam-arti/Unconditional_Video_genration/g4an-3gpu/evaluation/eval_video_g4_flip_sample_1_2_masking_v3_Gv_only_5000')
